...
func EnsureFail(t *testing.T, c *core.CheckBase) (msg string, ok bool) {
...
// still not fail.
func EnsureNoFail(t *testing.T, c *core.CheckBase) (msg string, ok bool) {
	if c.Result.Status == core.Fail {
...
func EnsurePass(t *testing.T, c *core.CheckBase) (msg string, ok bool) {
...
func EnsureFailures(t *testing.T, c *core.CheckBase, expectedFailures []string) (msg string, ok bool) {
...
func EnsurePasses(t *testing.T, c *core.CheckBase, expectedPasses []string) (msg string, ok bool) {
